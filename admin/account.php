<?php 
	...
	$id= $_SESSION['MadhusData']['Madhus_id'];
// Call stored procedure
    $stmt = $con->prepare("CALL getAdminByID(?)");
    ...
    if ($result1) {
        $admin = $result1->fetch_all(MYSQLI_ASSOC);
        $finalAdmin=$admin[0];
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    ...
										    <div class="item-data"><img class="profile-image" src="assets/images/user.jpg" alt=""></div>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data"><?=$finalAdmin['fullname']?></div>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data"><?=$finalAdmin['email']?></div>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
							    <div class="item border-bottom py-3">
